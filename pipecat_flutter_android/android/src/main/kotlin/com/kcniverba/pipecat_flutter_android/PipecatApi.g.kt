...
enum class BotOutputSpokenStatus(val raw: Int) {
  ...
  companion object {
    fun ofRaw(raw: Int): BotOutputSpokenStatus? {
      return values().firstOrNull { it.raw == raw }
    }
  }
}
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class SendLlmFunctionCallResultParams (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): SendLlmFunctionCallResultParams {
      ...
      return SendLlmFunctionCallResultParams(functionName, toolCallId, argumentsJson, resultJson)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class SendClientRequestParams (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): SendClientRequestParams {
      val msgType = pigeonVar_list[0] as String
      val dataJson = pigeonVar_list[1] as String
      return SendClientRequestParams(msgType, dataJson)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is SendClientRequestParams) {
      return false
    }
    if (this === other) {
      return true
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class SendClientRequestResult (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): SendClientRequestResult {
      val msgType = pigeonVar_list[0] as String
      val dataJson = pigeonVar_list[1] as String
      return SendClientRequestResult(msgType, dataJson)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is SendClientRequestResult) {
      return false
    }
    if (this === other) {
      return true
...
) : PipecatEvent()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): BotOutputEvent {
      val text = pigeonVar_list[0] as String
      val aggregatedBy = pigeonVar_list[1] as String
      val willBeSpoken = pigeonVar_list[2] as Boolean?
      val spokenStatus = pigeonVar_list[3] as BotOutputSpokenStatus?
      val accumulatedText = pigeonVar_list[4] as String?
      val remainingText = pigeonVar_list[5] as String?
      val segmentId = pigeonVar_list[6] as Long?
      return BotOutputEvent(text, aggregatedBy, willBeSpoken, spokenStatus, accumulatedText, remainingText, segmentId)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
private open class PipecatApiPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      130.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
          BotOutputSpokenStatus.ofRaw(it.toInt())
        }
      }
      131.toByte() -> {
        return (readValue(buffer) as Long?)?.let {
...
interface PipecatHostApi {
  ...
  fun sendClientRequest(parameters: SendClientRequestParams, callback: (Result<SendClientRequestResult>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: PipecatHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.com.kcniverba.pipecat_flutter.PipecatHostApi.sendLlmFunctionCallResult$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.com.kcniverba.pipecat_flutter.PipecatHostApi.sendClientRequest$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val parametersArg = args[0] as SendClientRequestParams
            api.sendClientRequest(parametersArg) { result: Result<SendClientRequestResult> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(PipecatApiPigeonUtils.wrapError(error))
              } else {
                val data = result.getOrNull()
                reply.reply(PipecatApiPigeonUtils.wrapResult(data))
              }
            }
          }
        } else {
