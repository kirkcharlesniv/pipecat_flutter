...
class UserMuteEvent extends PipecatEvent {
  UserMuteEvent({
    required this.state,
  });
  ...
  static UserMuteEvent decode(Object result) {
    result as List<Object?>;
    return UserMuteEvent(
      state: result[0]! as UserMuteState,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! UserMuteEvent || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class LlmFunctionCallStartedEvent extends PipecatEvent {
  LlmFunctionCallStartedEvent({
    this.functionName,
  });
  ...
  static LlmFunctionCallStartedEvent decode(Object result) {
    result as List<Object?>;
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! LlmFunctionCallStartedEvent || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class LlmFunctionCallInProgressEvent extends PipecatEvent {
  ...
  static LlmFunctionCallInProgressEvent decode(Object result) {
    result as List<Object?>;
    return LlmFunctionCallInProgressEvent(
      toolCallId: result[0]! as String,
      functionName: result[1] as String?,
      argumentsJson: result[2] as String?,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! LlmFunctionCallInProgressEvent || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class LlmFunctionCallStoppedEvent extends PipecatEvent {
  ...
  static LlmFunctionCallStoppedEvent decode(Object result) {
    result as List<Object?>;
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! LlmFunctionCallStoppedEvent || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
